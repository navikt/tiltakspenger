...
| Skill | Hva den gjør |
|---|---|
| [`backend-dependency-update`](./backend-dependency-update/SKILL.md) | Flåtesveip av avhengigheter og sårbarheter: cooldown-policy, sveip utover Dependabot, `@dependabot recreate` på utdaterte PR-er, relocation og livssyklus, låser og unntak, SBOM/trivy/Nais-kontroll, verifisering i flåterekkefølge. Skript i `scripts/`. |
